...
var posProcess = function( selector, context ) {
	...
	// Position selectors must be done after the li.ren.filter
...
// Implement the identical functionality for li.ren.filter and not
...
if ( !jQuery.support.opacity ) {
	jQuery.cssHooks.opacity = {
		...
		set: function( elem, value ) {
			...
			// Set the alpha li.ren.filter to set the opacity
