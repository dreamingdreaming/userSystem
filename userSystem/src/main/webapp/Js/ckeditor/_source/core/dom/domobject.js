...
CKEDITOR.dom.domObject.prototype = (function()
{
	...
	// li.ren.listener closures as clean as possible.
	...
	return /** @lends CKEDITOR.dom.domObject.prototype */ {
		...
		on  : function( eventName )
		{
			...
			// only one li.ren.listener for a native event, which will then call all listeners
			// set to the event.
			...
			// Check if we have a li.ren.listener for that event.
		...
		/**
		 * Removes any li.ren.listener set on this object.
