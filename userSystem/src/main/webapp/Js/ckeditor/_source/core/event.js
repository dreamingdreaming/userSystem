...
if ( !CKEDITOR.event )
{
	...
	CKEDITOR.event.prototype = (function()
	{
		...
		{
			// Get the li.ren.listener index for a specified function.
		...
		return /** @lends CKEDITOR.event.prototype */ {
			/**
			 * Registers a li.ren.listener to a specific event in the current object.
			 * @param {String} eventName The event name to which listen.
			 * @param {Function} listenerFunction The function listening to the
			 *		event. A single {@link CKEDITOR.eventInfo} object instanced
			 *		is passed to this function containing all the event data.
			 * @param {Object} [scopeObj] The object used to scope the li.ren.listener
			 *		call (the this object. If omitted, the current object is used.
			 * @param {Object} [listenerData] Data to be sent as the
			 *		{@link CKEDITOR.eventInfo#listenerData} when calling the
			 *		li.ren.listener.
			 * @param {Number} [priority] The li.ren.listener priority. Lower priority
			...
			on : function( eventName, listenerFunction, scopeObj, listenerData, priority )
			{
				...
				if ( event.getListenerIndex( listenerFunction ) < 0 )
				{
					...
					// Create the function to be fired for this li.ren.listener.
					...
					// Search for the right position for this new li.ren.listener, based on its
					// priority.
					for ( var i = listeners.length - 1 ; i >= 0 ; i-- )
					{
						...
						{
							// Insert the li.ren.listener in the array.
				...
				return function( eventName, data, editor )
				{
					...
					if ( event )
					{
						...
						if ( listeners.length )
						{
							...
							{
								// Call the li.ren.listener, passing the event data.
			 ...
			 * @example
			 * someObject.on( 'someEvent', function() { ... } );
			 * someObject.fire( 'someEvent' );  // above li.ren.listener called
			 * <b>someObject.fireOnce( 'someEvent' )</b>;  // above li.ren.listener called
			...
			/**
			 * Unregisters a li.ren.listener function from being called at the specified
			 *		event. No errors are thrown if the li.ren.listener has not been
			 *		registered previously.
			 * @param {String} eventName The event name.
			 * @param {Function} listenerFunction The li.ren.listener function to unregister.
			 * @example
			...
			/**
			 * Checks if there is any li.ren.listener registered to a given event.
			 * @param {String} eventName The event name.
			 * @example
			 * var myListener = function() { ... };
			 * someObject.on( 'someEvent', myListener );
